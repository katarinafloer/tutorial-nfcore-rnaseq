...
| `~/.ssh/` | Folder containing SSH keys used to connect to remote servers like Unity |
...
cd /Users/kfloer/Desktop/practice  # exactly the same, written out in full
```

::: {.callout-tip}
When you are unsure where you are, use an absolute path. It works from anywhere and never depends on your current location. This is especially important on Unity, where you will be navigating between your home directory, the lab `/work/` folder, and your scratch workspace.
:::
...
```text
-rw-r--r--  1 kfloer  staff   1.1K Aug  7 14:23 notes.txt
```
...
| Owner | `kfloer` | The user who owns the file |
